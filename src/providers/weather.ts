...
export class Weather {
  ...
  private weatherKey = '22a46ed2f155a058b03f117d6158967b';  // Activation of an API key for Free and Startup accounts takes 10 minutes.
  ...
  private makeDataURL(loc: any, command: string): string {
    ...
    // for temperature in fahrenheit use units=imperia
